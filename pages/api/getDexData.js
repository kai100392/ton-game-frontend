...
export const getLiquidityDataFromDex = async (tokenAddresses) => {
  ...
  console.log("dex liquidity.quote...", data.pairs ? data.pairs[0].liquidity.quote : -1);
  return data.pairs ? data.pairs[0].liquidity.quote : 0
};
