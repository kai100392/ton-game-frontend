...
const MarketPage = () => {
  ...
  sx={{
    ...
    whiteSpace: "nowrap", // Prevent wrapping so the content scrolls horizontally
...
>
  {/* Add content here, such as wide images or text */}
  {/* Example content that scrolls horizontally */}
  <div style={{ display: 'inline-block', width: '300px', height: '100px', backgroundColor: '#ff0000', marginRight: '10px' }}></div>
  <div style={{ display: 'inline-block', width: '300px', height: '100px', backgroundColor: '#00ff00', marginRight: '10px' }}></div>
  <div style={{ display: 'inline-block', width: '300px', height: '100px', backgroundColor: '#0000ff' }}></div>
</Card>
